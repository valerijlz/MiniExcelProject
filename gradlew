...
if [ -f /etc/alpine-release ]; then
    # Alpine Linux uses musl libc, which does not support some features of glibc
    # effectively bypass max file descriptors optimization
    MAX_FD="allow"
fi
...
# Collect all arguments for the java command, parameters with spaces require extra care
set -- "$@"
